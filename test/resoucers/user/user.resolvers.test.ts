                ...
                it('should return an error if User not exists', () => {
                    ...
                    return chai.request(app)
                        ...
                        .then(res => {
                            ...
                            expect(res.body.errors[0].message).to.equal('Error: Error User with id -1 not found!');
                        }).catch(handleError);
                ...
                it('should block operation if token is not provided', () => {
                    ...
                    return chai.request(app)
                        ...
                        .then(res => {
                            ...
                            //expect(res.body.errors[0].message).to.equal('TypeError: Cannot read property \'id\' of undefined');
                        }).catch(handleError);
